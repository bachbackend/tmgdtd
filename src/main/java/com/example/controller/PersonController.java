...
//    private final String fixedPassword = "admin1";

//    private final ImageService imageService;

    @Autowired
    public PersonController(PersonService personService, TransactionHistoryRepository transactionHistoryRepository, UpdateHistoryRepository updateHistoryRepository, PersonRepository personRepository, LoginRepository loginRepository) {
...
//    }
        ...
        public ResponseEntity<String> registerUser (@RequestBody Login login){
            try {
                personService.registerUser(login);
        ...
        public ResponseEntity<Login> loginUser (@RequestBody Login login){
            Login loggedInUser = personService.loginUser(login.getUserName(), login.getPassword());
        ...
        public ResponseEntity<List<Login>> getAllLoginInfor () {
            List<Login> logins = personService.getAllLoginInfor();
        ...
        public ResponseEntity<String> changePassword (@RequestBody Login login){
            try {
                personService.changePassword(login.getUserName(), login.getCurrentPassword(), login.getNewPassword());
